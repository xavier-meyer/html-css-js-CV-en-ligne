...
boutonsOffcanvas(enSavoirPlusBoutonsDroite);
// boutonsOffcanvas(enSavoirPlusBoutonsGauche);

 function boutonsOffcanvas(param){
    // je boucle tous les boutons récupérés par leur nom de class
    for(let i=0; i < enSavoirPlusBoutonsDroite.length; i++){
        // pour chaque bouton "en savoir plus", on lance une fonction au click
        enSavoirPlusBoutonsDroite[i].onclick = function(){
            ...
            for(let i =0; i < offcanvasPortfolio.length; i++){
                ...
                if(document.body.offsetWidth <= 768){
                    ...
                    offcanvasPortfolio[i].style.width = document.body.offsetWidth-20+"px";
                    let calcGoutierePetitEcran = (document.body.offsetWidth-offcanvasPortfolio[i].offsetWidth)/2;
                    document.body.style.padding = 0;
                    offcanvasPortfolio[i].style.marginTop = "15px";
